<<<<<<< HEAD:go-approach/examples/switchTSN-david/temporal3.go
package main
...
func updateGlobalVariable(queues int) {
	...
	for {
		...
		case <-ticker.C:
			...
			log.Printf("Prio queue updated to %d", globalVariable)
			lock.Unlock()
		}
	}
}
...
>>>>>>> 8828a2e42961a31527bf4d866680a5b0bbc5b10f:go-approach/projects/switchTSN-david/temporal3.go
