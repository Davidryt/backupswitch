...
struct bpf_map_def SEC("maps") xdp_stats_map = {
	...
	.type        = BPF_MAP_TYPE_PERCPU_ARRAY,  //use cpu storage
...
{
	void *data_end = (void *)(long)ctx->data_end;   //MEDIMOS FINAL PAQUETE
	void *data     = (void *)(long)ctx->data;	//MEDIMOS PRINCIPIO
	struct datarec *rec;
	...
	lock_xadd(&rec->rx_packets, 1);
         ...
         */
        __u64 bytes = data_end - data; 		//TAMAÑO DEL PAQUETE
